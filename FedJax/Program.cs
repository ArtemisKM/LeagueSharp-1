...
namespace FedJax
{
    internal class Program
    {
        ...
        {
            if (IgniteSlot == SpellSlot.Unknown || ObjectManager.Player.Spellbook.CanUseSpell(IgniteSlot) != SpellState.Ready) return;
        ...
        {
            var iTarget = TargetSelector.GetTarget(Q.Range, TargetSelector.DamageType.Physical);
        ...
        {
            var hTarget = TargetSelector.GetTarget(Q.Range, TargetSelector.DamageType.Physical);
